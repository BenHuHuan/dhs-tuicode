...
class CliMockAdapter extends LlmAdapter {
  ...
  async * stream(options: GenerateOptions): AsyncIterable<StreamChunk> {
    ...
    if (toolResult === undefined) {
      ...
      yield { type: 'tool-call-delta', index: 0, id: CallId('cli-smoke-call'), name: SHELL_TOOL, argumentsDelta: args }
      yield { type: 'block-end', index: 0, block: { type: 'tool-call', id: CallId('cli-smoke-call'), name: SHELL_TOOL, arguments: args } }
