...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  McpConnectionRegistration: 'mcp.md',
  McpConnectionSnapshot: 'mcp.md',
  McpConnectionState: 'mcp.md',
  McpConnectionTransport: 'mcp.md',
  McpConnectionUpdate: 'mcp.md',
  LspProvider: 'lsp.md',
